...
Definition: a thing is initially-described if its initial appearance is not "" and it is not handled.
...
Rule for deciding whether all includes something (called special-target) while taking (this is the excluding concealed items rule): 
	change special-target to marked for listing;
