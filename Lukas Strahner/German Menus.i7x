...
""	"[current menu title]"	""
""	""	" "
" N = Nächstes"	""	"Q = [if menu depth > 1]Zurück[otherwise]Beenden[end if]"
...
Die German Menus Extension ist eine direkte Übersetzung von Emily Short's gleichnamiger Extension. Es wurden lediglich alle Texte dieser außerordentlich nützlichen Extension ins Deutsche übersetzt.

Diese Extension benötigt die Extensions "Basic Screen Effects" und "Menus" von Emily Short, sowie "German Basic Screen Effects" von Lukas Strahner und bindet sie automatisch in das Projekt ein.

Für die weitere Handhabung, siehe Emily Short's Dokumentation zu Menus.