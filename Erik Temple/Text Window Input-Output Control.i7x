Version 2 of Text Window Input-Output Control (for Glulx only) by Erik Temple begins here.
...
The current text input window is a g-window that varies. The current text input window is the main-window.

The current text output window is a g-window that varies. The current text output window is the main-window.
