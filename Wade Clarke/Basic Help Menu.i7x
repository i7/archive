Version 1/130609 of Basic Help Menu by Wade Clarke begins here.
...
You can also add elements to a table by including a continuation of them in your game's source code, like so:
	...
	used	bookpage	localpage	title	subtable (table name)	description (text)	toggle (rule)
	0	0	0	"Contacting the author"	--	"If you have any difficulties with [story title], please contact me at..."	--
...
2. The extension name mentioned in the first line of the extension source code must be changed to the new name.
...
Example: * Basics - A very small game mostly consisting of help.
	...
	*: "Basics"
	...
	table of hints
	used	bookpage	localpage	title	subtable (table name)	description (text)	toggle (rule)
	0	0	0	"What do I do with the string?"	table of hinting	"Remember that you know how to macrame."	--
	0	0	0	"hint"	--	"Oh, come now, isn't it obvious?"	--
