...
p2v-message	message
need-not-move	"Already here.[line break]"
...
Report an actor inviting something to     	(this is the default inviting     report rule): say "[The actor] invites [the noun][if the second noun is not nothing] to [the second noun][end if]."   
Report an actor permitting something to 	(this is the default permitting report rule): say "[The actor] permits [the noun] access[if the second noun is not nothing] to [the second noun][end if]."   
Report an actor forbidding something from 	(this is the default forbidding report rule): say "[The actor] forbids [the noun][if the second noun is not nothing] from [the second noun][end if]."   
