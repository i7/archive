Scope Control by Ron Newcomb begins here.
...
Section 1 - Scope Control extension
...
Section 2 - really only useful for testing scope control - not for release - unindexed 
...
Try the following test both with and without including this extension and its purpose becomes clear.
	...
	*: "Asking for Directions"
	...
	After deciding the scope of the player while parsing for persuasion and when Jesse is lost in it: 
		place Jesse in scope.
	...
	A description of Jesse is "A brunette in a pullover hoodie and jeans, and with legs made for striding up hills, Jesse has finally made it out to visit." 
