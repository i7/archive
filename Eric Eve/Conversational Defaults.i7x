Version 2 of Conversational Defaults by Eric Eve begins here.
...
The last default response rule (this is the unresponsive rule): 
 say "[The current interlocutor] do[if the current interlocutor is singular-named]es[end if] not respond."
