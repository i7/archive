Version 2 of Deluxe Doors by Emily Short begins here.
...
Include Locksmith by Emily Short. Include Plurality by Emily Short.
...
Does the player mean doing something with a door which is a half-door of a door in the location:
	it is very unlikely.
	
Rule for clarifying the parser's choice of an open door which is a half-door of something: do nothing instead.
