...
To repeat with (R - nonexisting rule variable) running through all/each/every/-- future events/event begin -- end: (-  {-allocate-storage:LoopingThruEvents} ! {-advance-counter:LoopingThruEvents} ! don't delete this comment
