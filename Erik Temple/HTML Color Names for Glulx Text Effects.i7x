Version 1/100619 of HTML Color Names for Glulx Text Effects (for Glulx only) by Erik Temple begins here.
...
Section 0 - Use options

Use authorial modesty.


Section 1 - Core table of color values

[The colors that are commented out are defined in either Glulx Text Effects or Flexible Windows.]
...
Section 2 - Colors provided by FW (for use without Flexible Windows by Jon Ingold)
...
Section 3 - Amended color table (for use with Flexible Windows by Jon Ingold)

[The colors in this table amendment are defined in Flexible Windows but differ in their definition.]
...
HTML Color Names for Glulx Text Effects extends the Table of Common Color Values from Glulx Text Effects. It provides the full list of HTML color names that are recognized by major browsers (see http://www.w3schools.com/html/html_colornames.asp ). These can be used to set text styles, to change window background colors, or to specify the color of graphic elements.

Note: You will need to include Glulx Text Effects or another extension that includes Glulx Text Effects before including this extension, e.g.:
