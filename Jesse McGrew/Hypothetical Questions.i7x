...
Here we use the extension to the give the player a bit of clairvoyance. After moving to another room, we hypothetically try picking up every object in the location, then test whether the player would have died, won the game, or gained points. If so, we print an appropriate message.
	...
	*: "A Sense of Adventure"
	...
	A golden idol is in the trophy room. After taking the golden idol for the first time, award 5 points.
	...
	A cursed idol is in the danger zone. After taking the cursed idol: say "As you pick up the idol, you feel an evil presence sucking the life force out of your body."; end the game in death.
	
	Winners' Lounge is south of the hallway. "This is where winners hang out. A door to the north leads back to the hallway."
	
	The Mask of Victory is here. "A strange mask is hanging on the wall here. A sign beneath it simply states: 'The Mask of Victory'." After taking the Mask of Victory, end the game in victory.
	...
	A player's fate rule when the game ended in death: player dies.
	
	A player's fate rule when the game ended in victory: player wins.
